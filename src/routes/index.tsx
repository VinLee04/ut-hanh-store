    ...
    <div ref={fullPageRef} className="bg-[#faf7f2] font-sans">
      ...
      <motion.header layout className="fixed top-0 inset-x-0 z-50">
        <div className={cn(
          ...
          <Link from={Route.fullPath} to='.' hashScrollIntoView={{ behavior: 'smooth' }} hash='hero'
            ...
            <span className='font-bold'>Ut <span className='text-[#8a6a30]'>Hanh</span></span>
          ...
          <div className="flex gap-x-5 items-center text-[13.5px] text-[#8a7a60]">
            <span className="font-medium text-[#5c4a2a]">{SHOP_INFO.phone}</span>
      ...
      <div>
        ...
        <section id='hero' ref={introduceRef}
          ...
          {/* Decorative circles */}
          <div className="absolute top-8 -right-20 w-80 h-80 rounded-full border border-[#b4a078]/15 pointer-events-none"/>
          <div className="absolute top-20 right-5 w-48 h-48 rounded-full border border-[#b4a078]/10 pointer-events-none"/>
          ...
          <div className="px-4 sm:px-6 md:px-10 pt-12 pb-6 flex flex-col overflow-y-auto touch-pan-y">
            ...
            >
              {[
                ...
                { label: "Đồ ăn vặt", hash: "anchor-do-an-mb" },
              ].map((tag) => (
                <Link
                  key={tag.label}
                  from={Route.fullPath}
            ...
            <Highlighter action="underline" color="#FF9800">
              <h1 className="font-serif text-[72px] leading-none font-bold text-[#2c2118] tracking-tight">
                <TextDisplayWrapper delay={0.35} y={20} className='h-18 text-nowrap'>
                  Ut{' '}
                  <em className="text-[#8a6a30] not-italic font-serif">Hanh</em>
                </TextDisplayWrapper>
              </h1>
            </Highlighter>
            ...
            <TextDisplayWrapper delay={0.8} y={20} childClassName className='h-8'>
              <Clock size={20}/> Hoạt động: 7:00 - 20:00
            </TextDisplayWrapper>
            ...
            <div className='mt-auto'>
              ...
              <TextDisplayWrapper delay={1} y={20} childClassName className='h-8'>
                <MapPin size={20}/> Ấp 7, xã Phú Long, huyện Bình Đại - Bến Tre
              </TextDisplayWrapper>
            </div>
          </div>
          ...
          <motion.div
            ...
            className="m-4 md:m-14 flex-1 relative rounded-2xl overflow-hidden border border-[#b4a078]/25 min-h-90"
          >
            <div
